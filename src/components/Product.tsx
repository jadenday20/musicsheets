...
const Product: React.FC<SongProps> = ({ name, composer, category, instruments, href }) => {
    ...
    return (
        <Link className="bg-slate-300 rounded drop-shadow-md p-5 min-h-fit w-full min-w-[330px] hover:opacity-70 hover:drop-shadow-xl duration-500 group flex flex-col justify-between" href={href}>
            <div>
                <h3>{name}</h3>
